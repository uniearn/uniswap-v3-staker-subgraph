...
export class Contract__depositsResult {
  value0: Address;
  value1: BigInt;
  value2: i32;
  value3: i32;
...
export class Contract__endIncentiveInputKeyStruct extends ethereum.Tuple {
  get rewardToken(): Address {
...
export class Contract__getRewardInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract__getRewardInfoInputKeyStruct extends ethereum.Tuple {
  get rewardToken(): Address {
    return this[0].toAddress();
  }
...
export class Contract__incentivesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  deposits(param0: BigInt): Contract__depositsResult {
    let result = super.call(
      "deposits",
    ...
    return new Contract__depositsResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toI32()
  ...
  try_deposits(param0: BigInt): ethereum.CallResult<Contract__depositsResult> {
    let result = super.tryCall(
      "deposits",
      "deposits(uint256):(address,uint48,int24,int24)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  endIncentive(key: Contract__endIncentiveInputKeyStruct): BigInt {
    let result = super.call(
      "endIncentive",
  ...
  try_endIncentive(
    key: Contract__endIncentiveInputKeyStruct
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "endIncentive",
      "endIncentive((address,address,uint256,uint256,address)):(uint256)",
  ...
  getRewardInfo(
    key: Contract__getRewardInfoInputKeyStruct,
    tokenId: BigInt
  ): Contract__getRewardInfoResult {
    let result = super.call(
      "getRewardInfo",
    ...
    return new Contract__getRewardInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getRewardInfo(
    key: Contract__getRewardInfoInputKeyStruct,
    tokenId: BigInt
  ): ethereum.CallResult<Contract__getRewardInfoResult> {
    let result = super.tryCall(
      "getRewardInfo",
      "getRewardInfo((address,address,uint256,uint256,address),uint256):(uint256,uint160)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__getRewardInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  incentives(param0: Bytes): Contract__incentivesResult {
    let result = super.call(
      "incentives",
    ...
    return new Contract__incentivesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_incentives(
    param0: Bytes
  ): ethereum.CallResult<Contract__incentivesResult> {
    let result = super.tryCall(
      "incentives",
      "incentives(bytes32):(uint256,uint160,uint96)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__incentivesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  stakes(tokenId: BigInt, incentiveId: Bytes): Contract__stakesResult {
    let result = super.call(
      "stakes",
  ...
  try_stakes(
    tokenId: BigInt,
    incentiveId: Bytes
  ): ethereum.CallResult<Contract__stakesResult> {
    let result = super.tryCall(
      "stakes",
      "stakes(uint256,bytes32):(uint160,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__stakesResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
...
export class CreateIncentiveCall__Inputs {
  ...
  get key(): CreateIncentiveCallKeyStruct {
    return this._call.inputValues[0].value.toTuple() as CreateIncentiveCallKeyStruct;
  }
...
export class EndIncentiveCall__Inputs {
  ...
  get key(): EndIncentiveCallKeyStruct {
    return this._call.inputValues[0].value.toTuple() as EndIncentiveCallKeyStruct;
  }
}
...
export class StakeTokenCall__Inputs {
  ...
  get key(): StakeTokenCallKeyStruct {
    return this._call.inputValues[0].value.toTuple() as StakeTokenCallKeyStruct;
  }
...
export class UnstakeTokenCall__Inputs {
  ...
  get key(): UnstakeTokenCallKeyStruct {
    return this._call.inputValues[0].value.toTuple() as UnstakeTokenCallKeyStruct;
  }
